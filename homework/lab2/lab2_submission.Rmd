...
```
We can see in the plot above that beta0 and beta[4] (i.e. the estimates for intercept and coefficient for roof, respectively) are highly correlated with Prior C. This is because priors for both were very weak in this model \textbf{SAY MORE HERE!}
...
\begin{itemize}
\item Intercept $\beta_{0}$ \~ No (-5.682, .007005)
\item EAVES:  	$\beta_{1}$ \~ No (1, .2164)
\item WINDOWS:	$\beta_{2}$ \~ No (1, .1105)
\item YARDS:	$\beta_{3}$ \~ No (1, .2061)
\item ROOF:    $\beta_{4}$ \~ No (1, .1337)  
\item Tau:	$\tau$ \~ Gamma(17, 1128)
\end{itemize}
